package io.management.ua.utility.api.np.service;
...
import io.management.ua.utility.api.np.models.CargoType;
import io.management.ua.utility.api.np.models.NPDepartmentType;
import io.management.ua.utility.api.np.models.NPRestrictions;
import io.management.ua.utility.api.np.models.http.requests.*;
import io.management.ua.utility.api.np.models.http.response.GeneralResponseModel;
import io.management.ua.utility.api.np.models.http.response.GetCitiesResponse;
import io.management.ua.utility.api.np.models.http.response.GetCityRefResponse;
import io.management.ua.utility.api.np.models.http.response.GetDocumentPriceResponse;
import io.management.ua.utility.api.np.models.http.response.warehouses.WarehouseModel;
import io.management.ua.utility.api.np.utility.Methods;
...
public class NovaPostDeliveryService {
    ...
    private GeneralRequestModel<GetDocumentPriceModel> getGetDocumentPriceModelGeneralRequestModel(ProductDeliveryModel productDeliveryModel, OrderShipmentAddressDTO deliveryParameters, BigInteger shipmentSeats) {
        ...
        if (!deliveryParameters.getAddress().containsKey(AddressPart.CITY_SENDER) || !deliveryParameters.getAddress().containsKey(AddressPart.REGION_RECIPIENT)) {
